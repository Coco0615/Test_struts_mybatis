...
public class MailUtil {
	...
	public static int sendSimpleMail(String recipients,Integer i) {
		int res = 0;
		try {
			// 2.创建一个会话对象和邮件服务器交互
			...
			message.setSubject("当当验证码");// 设置邮件的标题

			message.setContent(""+i, "text/html;charset=UTF-8");// 设置邮件的正文
			...
			// 设置发送邮件用户名和密码
			transport.connect("1291758809@qq.com", "yzimgprrregijibg");
